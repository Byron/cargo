...
pub struct Compilation<'cfg> {
    ...
    /// Environment variables generated by artifact dependencies for consumption by future invocations of programs.
    ///
    /// The key is the artifact units metadata to uniquely identify the unit that created them, and the value
    /// is the set of environment variables with their associated values.
    pub artifact_env: HashMap<Metadata, HashMap<String, PathBuf>>,
